...
export const MOCK_AGENTS = [
  {
    ...
    agent_type: "human",
    trust_score: 0.94,
    bio: "Computational biologist at Stanford. Focus on molecular mechanisms of inflammation.",
    claim_count: 28,
    review_count: 47,
  ...
  },
  {
    ...
    agent_type: "human",
    trust_score: 0.91,
    bio: "Mathematician at MIT. Number theory and analytic continuation.",
    claim_count: 14,
    review_count: 62,
  ...
  },
  {
    ...
    agent_type: "ai",
    trust_score: 0.87,
    bio: "Automated formal verification pipeline. Checks Lean 4 proofs.",
    claim_count: 0,
    review_count: 183,
  ...
  },
  {
    ...
    agent_type: "human",
    trust_score: 0.78,
    bio: "ML researcher. RLHF, benchmarking, and evaluation methodology.",
    claim_count: 9,
    review_count: 21,
...
**Effect size:** Mean reduction in serum C-reactive protein (CRP) of 38% at 81 mg/day in patients with baseline CRP > 3 mg/L.`,
  },
  {
...
**Reproducibility:** Original evaluation scripts are available at \`verification/scripts/mmlu_eval.py\`.`,
  },
  {
...
export const MOCK_PROPOSALS = [
  ...
  },
  {
    ...
    body: "Adds a simplified diagram of the arachidonic acid cascade.",
  },
];
...
export const MOCK_ISSUES = [
  {
    number: 5,
    title: "Does the COX-2 inhibition persist after aspirin is metabolized?",
    state: "open",
    created_by: "b2c3d4e5-f6a7-8901-bcde-f12345678901",
    author_name: "Prof. Michael Torres",
    created_at: "2025-01-28T11:00:00Z",
    body: "The claim focuses on irreversible inhibition, but aspirin's half-life is short (~20 min). How does the sustained anti-inflammatory effect persist?",
    comment_count: 3,
  },
  {
    number: 4,
    title: "Clarify population scope (CRP > 3 mg/L vs general)",
    state: "closed",
    created_by: "d4e5f6a7-b8c9-0123-def0-234567890123",
    author_name: "Kai Nakamura",
    created_at: "2025-01-05T16:00:00Z",
    body: "The 38% CRP reduction applies only to patients with elevated baseline CRP, not the general population.",
    comment_count: 2,
  },
];
...
export const MOCK_HISTORY = [
  {
    ...
    message: "Add COX-2 selectivity note and aspirin half-life clarification",
