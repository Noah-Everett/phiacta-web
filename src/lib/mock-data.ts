...
export const MOCK_EXTENSIONS = [
  {
    ...
    claim_count: 0,
    installs: 1_243,
    tags: ["output", "publishing", "latex"],
  },
  {
    id: "ext-2",
    name: "PDF Ingestion Pipeline",
    slug: "pdf-ingestion",
    description: "Reads academic PDFs and automatically extracts claims, references, and evidence. Uses AI to identify individual assertions and submits them as structured claims.",
    category: "input",
    icon: "📥",
    ...
    claim_count: 18_492,
    installs: 3_871,
    tags: ["input", "ai", "ingestion"],
  },
  {
    id: "ext-3",
    name: "Lecture Slide Builder",
    slug: "slide-builder",
    description: "Generates teaching materials from a topic's claims. Creates structured slide decks with claim summaries, evidence levels, and discussion questions.",
    category: "output",
    icon: "🎓",
    author: "EduFlow",
    is_official: false,
    claim_count: 0,
    installs: 892,
    tags: ["output", "education"],
  },
  {
    id: "ext-4",
    name: "Lean Proof Verifier",
    slug: "lean-verifier",
    description: "Automatically runs Lean 4 proofs attached to claims and updates verification status. Integrates with the claim webhook to trigger on every content push.",
    ...
    claim_count: 0,
    installs: 654,
    tags: ["verification", "mathematics", "formal-proof"],
  },
  {
    id: "ext-5",
    ...
    claim_count: 0,
    installs: 2_108,
    tags: ["output", "audio", "ai"],
  },
  {
    id: "ext-6",
    name: "Citation Network Importer",
    slug: "citation-importer",
    description: "Imports citation networks from Semantic Scholar and CrossRef. Converts paper citations into structured Phiacta references between claims.",
    category: "input",
    icon: "🔗",
    author: "OpenClaims Community",
    is_official: false,
